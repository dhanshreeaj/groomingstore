    ...
    >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to TechTapestry, 808, Plot No. 195, Shagun
            Insignia, Sector 19, Ulwe, 410206.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Stallion Grooming, accessible
            from{" "}
            <a
              href="https://www.stalliongrooming.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.stalliongrooming.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.stalliongrooming.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.stalliongrooming.com/contact
          </a>
        </li>
      </ul>
    </Container>
